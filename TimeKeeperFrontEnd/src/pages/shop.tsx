        ...
        <>
            ...
            <div className="bg-pro">
                <div className="categories">
                    <button className="cteg-btn" onClick={() => setSelectedCategory('Rolex')}>Rolex</button>
                    <button className="cteg-btn" onClick={() => setSelectedCategory('Armani')}>Armani</button>
                    <button className="cteg-btn" onClick={() => setSelectedCategory('Tissot')}>Tissot</button>
                    <button className="cteg-btn" onClick={() => setSelectedCategory('Omega')}>Omega</button>
                    <button className="cteg-btn" onClick={() => setSelectedCategory('Daniel Wellington')}>Daniel Wellington</button>
                    <button className="cteg-btn" onClick={() => setSelectedCategory('Seiko')}>Seiko</button>
